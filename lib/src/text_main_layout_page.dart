...
import '../flutter_tag_layout_null_safety.dart';
      ...
      switch (backgroundModel) {
        ...
        case TextLayoutBackgroundModel.ovalBorder:
          border = textModel.border ??
              Border.all(color: backgroundColor, width: 0.5);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: const BorderRadius.all(Radius.circular(9)),
                boxShadow: [
                  BoxShadow(color: fontColor, offset: const Offset(2, 2)),
                  BoxShadow(color: fontColor, offset: const Offset(-2, -2))
                ]),
          ),
          Container(
